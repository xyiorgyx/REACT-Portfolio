...
export default function Projectcards() {
    ...
    return (
        <>
            <div className="flex flex-wrap w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
                ...
                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-18 my-5">
                    ...
                    <div className="p-5">
                        ...
                        <p className="max-h-40 mb-3 font-normal text-gray-700 dark:text-gray-400 overflow-auto">The work day scheduler is a simple daily planner. The date is updated everytime the page is opened, showing the current date ontop of the page. The planner runs from 9am - 8pm. With each color box, telling the user whether it is in the past (grey), the present(red), or the future(Green).</p>
